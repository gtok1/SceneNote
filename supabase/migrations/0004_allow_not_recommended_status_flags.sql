...
COMMENT ON COLUMN user_library_items.status_flags IS
  'User-selected watch status toggles. Display order is fixed in the client as wishlist, watching, completed, not_recommended. Dropped is deprecated and deletion is handled by removing the library item.';
